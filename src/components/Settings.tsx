...
function Board() {
  ...
  return (
    <div className="flex items-stretch justify-between gap-2 p-2">
      <div className="flex items-center gap-2">
        ...
        <div className="flex w-fit items-center">
          <input
            ...
            className="w-12 rounded-md border-neutral-200 px-2 py-1 text-center tabular-nums invalid:border-red-500 invalid:ring-red-600 invalid:focus:border-red-600 invalid:focus:ring max-md:flex-1 dark:border-neutral-800 dark:bg-neutral-700"
          />
      ...
      <button
        type="reset"
        className="shrink-0 rounded-md border border-neutral-200 bg-neutral-900 px-3 py-1 font-medium text-white hover:bg-neutral-800 dark:border-neutral-800 dark:bg-neutral-700 dark:hover:bg-neutral-600"
        onClick={() => {
    ...
    <div className="p-2">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex gap-2">
          <button
            className="flex items-center justify-center rounded-full border border-neutral-200 p-1.5 dark:border-neutral-800 dark:bg-neutral-700 dark:hover:bg-neutral-600"
